...
export default getRequestConfig(async ({ locale }) => {
  const [common, pages, errors, billing, projects, notifications, copilot] = await Promise.all([
  ...
  return { messages: { common, pages, errors, billing, projects, notifications, copilot } }
})
